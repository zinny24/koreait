...
SELECT L.large_cate_code, L.large_cate_name, S.small_cate_code, S.small_cate_name
FROM large_category L INNER JOIN small_category S ON L.large_cate_code = S.large_cate_code;
...
GROUP BY L.large_cate_name, L.large_cate_code;
